  ...
  <div style="display:flex;gap:12px;align-items:flex-start;">
    ...
    <div style="flex:1;">
      ...
      <p style="margin:0 0 10px;color:#475569;font-size:14px;line-height:1.5;">
        Votre réservation est en attente de réception du virement bancaire.
        Merci d'effectuer le virement pour confirmer votre réservation.
      </p>

      <div style="font-size:30px;font-weight:900;color:#0F172A;">
        <?php echo number_format_i18n((float)$total, 2); ?> €
        <span style="font-size:14px;font-weight:700;color:#64748B;">via virement bancaire</span>
      </div>
    </div>
  </div>
</div>
