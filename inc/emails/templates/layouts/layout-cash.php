...
if ( ! function_exists('logestay_email_badge_html') ) {
  function logestay_email_badge_html(array $badge): string {
    ...
    $map = [
      ...
      'neutral' => ['bg'=>'#E5E7EB', 'fg'=>'#111827', 'icon'=>'ℹ️'],
    ];
  ...
  <div style="display:flex;gap:12px;align-items:flex-start;">
    ...
    <div style="flex:1;">
      ...
      <div style="font-size:30px;font-weight:900;color:#0F172A;">
        ...
        <span style="font-size:14px;font-weight:700;color:#64748B;">via <?php echo esc_html($email_method_label); ?></span>
      </div>
    </div>
  </div>
</div>
